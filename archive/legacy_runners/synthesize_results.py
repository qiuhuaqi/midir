...
parser.add_argument('--json_in', default='test_metrics_results.json',
                    help='Name of the files to search and collect result')
parser.add_argument('--csv_out', default='test_results.csv',
...
def aggregate_metrics(parent_dir, metrics):
    ...
    metrics_file = os.path.join(parent_dir, '{}'.format(args.json_in))
...
if __name__ == "__main__":
    ...
    save_file = os.path.join(args.parent_dir, "{}".format(args.csv_out))
