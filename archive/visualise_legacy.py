""" v0.3: legacy visualisation code from the initial cardiac motion phase of the the project """
...
def save_train_result(target, source, warped_source, dvf, save_result_dir, epoch, fps=20, dpi=40):
    ...
    for fr in range(dvf.shape[0]):
        ...
        plot_results_old(target_fr, source_fr, warped_source_fr, dvf_fr, save_path=fig_save_path, dpi=dpi)
